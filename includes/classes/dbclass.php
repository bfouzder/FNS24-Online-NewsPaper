...
class dbclass
{
    ...
    // Need to set these constant variables:
       ...
       // function dbclass(){ //Deprecated: Methods with the same name as their class will not be constructors in a future version of PHP; 
        ...
        function error($text=false){
	        	...
	        	if($this->SHOW_ERROR){
			    echo "<br/><i>&raquo;&raquo;&nbsp; SQL-ERROR &raquo;&raquo;&nbsp;" .mysql_errno() ."&nbsp;&raquo;&raquo;&nbsp; ". mysql_error()." &nbsp;&laquo;&laquo;<br/>&raquo;&raquo;&nbsp; ".$text." &nbsp;&laquo;&laquo;</i>";
	            exit;
	           }
        }
		...
		function getColumns($tableName){
			...
			$columns = array();
			$query = mysql_query('DESC ' . $tableName);
