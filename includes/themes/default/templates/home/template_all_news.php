  <section class="section-block clearfix">
	<div class="row">
		<div class="col-xs-12 col-sm-9">
			<h2 class="nav-page-title"><?=$page_title?></h2>
		     <div class="page-breadcrumb clearfix">
			    <ol class="breadcrumb">
        		    <li><a href="<?=SCRIPT_URL?>"><i class="fa fa-home"></i> প্রচ্ছদ</a></li>				
					<li><a href="<?=SCRIPT_URL?>"><?=$page_title?></a></li>	
				</ul>
			</div>
		  <!--eof top heading-->	
...
if($news_rows){
	//pre($news_cat_rows);
	foreach($news_rows as $k=>$news_info){
 ...
 ?>          
		...
		<div class="col-xs-12 col-sm-3">
            ...
            <div class="fb-block" style="margin: 0px auto 10px;">
