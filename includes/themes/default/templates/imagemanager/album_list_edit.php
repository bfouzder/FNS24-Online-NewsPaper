...
<div class="form-group">
	<div class="col-sm-12">
		...
		<select name="album_cats[]" class="form-control optgroup" id="my-select" multiple="multiple" required>
	...
	<div class="col-sm-12">
		...
		<textarea name="description"  class="form-control" required><?=$album_info['description']?></textarea>
	</div>

	  <div class="col-sm-12">
		<label for="inputprepared_by" class="control-label">Photographer:</label>
		<input name="reporter" type="text" class="form-control" value="<?=$album_info['reporter']?>" required/>
	  </div>
...
<div class="clearfix"></div>
  ...
  <div class="form-group">
	<div class="col-sm-offset-1 col-sm-10">
	 ...
	 $manage_images_link = SCRIPT_URL."imagemanager/popup_imagemanager/?type=image_albums&type_id=$album_id";
	?>
	 <a href="<?=$manage_images_link?>" class="fancybox fancybox.iframe"><button type="button" class="btn btn-warning">Manage Images</button>
	</div>
  </div>
</form>
