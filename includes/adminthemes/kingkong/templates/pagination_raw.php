...
<ul class="pagination">
         ...
         <?php
		echo '<li><a href="'.SCRIPT_URL.$link.'page='.$pages['first'].'">First</a></li>';
		
		 if(isset($pages['prev_page'])){
    		echo '<li><a href="'.SCRIPT_URL.$link.'page='.$pages['prev_page'].'">&laquo; Previous</a></li>';
    	}
	 	foreach($pages['page_list'] as $k=>$v){
			echo '<li><a href="'.SCRIPT_URL.$link.'page='.$k.'"><b>'.$v.'</b></a></li>';
		} 
		
		if(isset($pages['next_page'])){
    		echo '<li><a href="'.SCRIPT_URL.$link.'page='.$pages['next_page'].'">Next&raquo;</a></li>';
    	}
		echo ' <li><a href="'.SCRIPT_URL.$link.'page='.$pages['last'].'">Last</a></li>';
