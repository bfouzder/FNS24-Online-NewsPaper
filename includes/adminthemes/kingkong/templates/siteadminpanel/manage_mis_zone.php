...
<div class="panel panel-success">
	<div class="panel-heading">
	  <h3 class="panel-title">Zone Information</h3>
	</div>
	<div class="panel-body">
		
		
		<div class="form-group">
		<label class="control-label col-md-2 col-sm-3 col-xs-12" for="name">Zone Name:<em>*</em></label>
		<div class="col-md-9 col-sm-9 col-xs-12">
		  <input type="text" name="ZoneName" required="required" value="<?=$edit['ZoneName']?>" class="form-control col-md-7 col-xs-12">
		</div>
		</div>
...
<div class="row" id="add_edit_block_list" <?=($edit)?' style="display:none"':' style="display:block"';?>>
    ...
    <div class="x_panel">
	  <div class="x_title">
		<h2><i class="fa fa-th-list"></i> List of MIS Zones</h2>                    
		<div class="clearfix"></div>
	  </div>
	  <div class="x_content">
