...
$panel_title="Add New Script";
?>
<div class="row" id="add_edit_block"  style="display:block">
<?php }elseif($edit){ 
$panel_title="Update Script";
?>
...
<div class="panel panel-success">
	...
	<div class="panel-body">
		...
		<label class="control-label col-md-2 col-sm-3 col-xs-12" for="name">Type:<em>*</em></label>
		<div class="col-md-9 col-sm-9 col-xs-12">
		  <input type="text" name="type" required="required" value="<?=$edit['type']?>" class="form-control col-md-7 col-xs-12">
		</div>
		</div>
		
		<div class="form-group">
		<label class="control-label col-md-2 col-sm-3 col-xs-12" for="name">Type ID:<em>*</em></label>
		<div class="col-md-9 col-sm-9 col-xs-12">
		  <input type="text" name="type_id" required="required" value="<?=$edit['type_id']?>" class="form-control col-md-7 col-xs-12">
		</div>
		</div>
		...
		<div class="form-group">
		<label class="control-label col-md-2 col-sm-3 col-xs-12" for="name">Log Text:<em>*</em></label>
		<div class="col-md-9 col-sm-9 col-xs-12">
		  <input type="text" name="log_text" required="required" value="<?= $edit['log_text'] ?>" class="form-control col-md-7 col-xs-12">
		</div>
		</div>

		<div class="form-group">
		<label class="control-label col-md-2 col-sm-3 col-xs-12" for="name">Log Link:<em>*</em></label>
		<div class="col-md-9 col-sm-9 col-xs-12">
		  <input type="text" name="log_link" required="required" value="<?= $edit['log_link'] ?>" class="form-control col-md-7 col-xs-12">
		</div>
		</div>

		<div class="form-group">
		<label class="control-label col-md-2 col-sm-3 col-xs-12" for="name">CRM:<em>*</em></label>
		<div class="col-md-9 col-sm-9 col-xs-12">
		  <input type="text" name="crm" required="required" value="<?= $edit['crm'] ?>" class="form-control col-md-7 col-xs-12">
		</div>
		</div>
...
<div class="row" id="add_edit_block_list" <?=($edit)?' style="display:none"':' style="display:block"';?>>
    ...
    <div class="x_panel">
	  <div class="x_title">
		<h2><i class="fa fa-th-list"></i> List of Script Log</h2>                    
		<div class="clearfix"></div>
	  </div>
	  <div class="x_content">
...
<div class="table-responsive">	
    <table class="table table-bordered">
        <thead>
            ...
            <th><form action="" method="get"> <select name="script_type" class="form-control" id="type" onchange="submit(this);"   >
				     <option value="">Filter by Script Type</option> 
				      <?=__getScriptOptions($db->get_post('script_type'));?>
...
<?php 
function __getScriptOptions($script_type){
	global $db;

	$script_array=array('member_login', 'another');
	foreach($script_array as $value){
		$sel=($script_type==$value)? ' selected="selected"':'';
