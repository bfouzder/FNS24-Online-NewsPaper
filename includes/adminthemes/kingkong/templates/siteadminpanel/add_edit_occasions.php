...
if($db->post('formSubmitted'))
	{
		...
		if(!$title){
		  $error ="Enter title";
		      ...
		      if(getOccassionInfoByName($title)){
...
<?php
$panel_title="Add New Occassion";
if($edit){ 
$panel_title="Update Occassion";
} 
?> 
 <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="row">	
		...
		<div class="form-group">
         ...
         <div class="form-group">
			<label class="control-label col-md-2 col-sm-3 col-xs-12" for="name">Occasion Date:</label>
			<div class="col-md-9 col-sm-9 col-xs-12">
		      	 <input type="text" id="single_cal2" name="occassion_date" value="<?= $edit['occassion_date'] ?>"  class="form-control col-md-7 col-xs-12">
			</div>
		</div>
        ...
        <div class="col-md-4 col-sm-9 col-xs-12">
             <?php 
            $avatar_image_src=($edit['avatar'])?IMAGE_URL.'occassions/medium_'.$edit['avatar']:GET_TEMPLATE_DIRECTORY_URI.'/images/blank_author.png';
            ?>
