...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12">
        <center>
        <h3><?=$type_title?></h3>
        <h2 style="color: orange;">Upload Photo</h2>
        </center>	
        ...
        <form class="form-inline" action="" method="post"  onsubmit="return checkUploadImageForm(this);" enctype="multipart/form-data">
        <input type="hidden" name="formSubmitted" value="true"/>
        
                <div class="form-group">
                    <label>Image</label><input  type="file" name="item_image" class="form-control"  required="required"/>
                </div>
                <div class="form-group">
                    <label>Caption</label><input  type="text" class="form-control"  name="image_caption" value=""/>
                </div>
                <div class="form-group">
                 <input type="submit" name="" value="Upload" class="btn btn-info" />&nbsp;&nbsp;<!--<input type="button" value="Close" onclick="MakeClose();"/>--></td></tr>
                </div>	  
        </form>
    </div>
</div>
...
<div class="row">		
		...
		?>
		   <div class="col-xs-4 col-sm-4 col-md-4">
				...
				<img src="<?=$image_info['image_path']?>" title="<?=$image_info['image_name']?>" alt="<?=$image_info['image_name']?>"  class="img-thumbnail" width="350"/>  
