...
$panel_title="Add New Book Category";
?>
<div class="row" id="add_edit_block"  style="display:block">
<?php }elseif($edit){ 
$panel_title="Update Book Category";
?>
...
<div class="panel panel-success">
	<div class="panel-heading">
	  <h3 class="panel-title">Book Category Information</h3>
	</div>
	<div class="panel-body">
    		...
    		<div class="col-md-9 col-sm-9 col-xs-12">
    		  <select name="parent" class="form-control" id="CategoryName" onchange="submit(this);"   >
    					     <option value="">Top Category</option> 
    					      <?=__getBooksParentOptions($edit['parent']);?>
    				  	</select>
    		</div>
		</div>
		...
		<div class="col-md-9 col-sm-9 col-xs-12">
		  <input type="text" name="CategoryName" required="required" value="<?=$edit['CategoryName']?>" class="form-control col-md-7 col-xs-12">
		</div>
		</div>
			
		<div class="form-group">
		<label class="control-label col-md-2 col-sm-3 col-xs-12" for="name">Remarks:<em>*</em></label>
		<div class="col-md-9 col-sm-9 col-xs-12">
		  <textarea name="CatRemarks" class="form-control"><?=$edit['CatRemarks']?></textarea>
		</div>
		</div>
...
<div class="row" id="add_edit_block_list" <?=($edit)?' style="display:none"':' style="display:block"';?>>
    ...
    <div class="x_panel">
	  <div class="x_title">
		<h2><i class="fa fa-th-list"></i> List of Book Categories</h2>                    
		<div class="clearfix"></div>
	  </div>
	  <div class="x_content">
            ...
            <th><form action="" method="get"> 
            		<select name="sparent" class="form-control" id="CategoryName" onchange="submit(this);"   >
					     <option value="">Filter by Parent</option> 
					      <?=__getBooksParentOptions($db->get_post('sparent'));?>
				  	</select>
				</form> 
			</th>
            </tr>
...
<?php 
	function __getBooksParentOptions($parentID=false){
		global $db;
		$types=$db->select("SELECT * FROM bn_book_category WHERE parent=0");
