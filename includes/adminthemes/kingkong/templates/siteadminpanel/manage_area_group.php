...
<div class="panel panel-success">
	...
	<div class="panel-body">
		...
		<label class="control-label col-md-2 col-sm-3 col-xs-12" for="name">Zone ID:<em>*</em></label>
		<div class="col-md-9 col-sm-9 col-xs-12">
		  <input type="text" name="ZoneID" required="required" value="<?=$edit['ZoneID']?>" class="form-control col-md-7 col-xs-12">
		</div>
		</div>
		
		<div class="form-group">
		<label class="control-label col-md-2 col-sm-3 col-xs-12" for="name">Area Group ID:<em>*</em></label>
		<div class="col-md-9 col-sm-9 col-xs-12">
		  <input type="text" name="AreaGroupID" required="required" value="<?=$edit['AreaGroupID']?>" class="form-control col-md-7 col-xs-12">
		</div>
		</div>

        <div class="form-group">
        <label class="control-label col-md-2 col-sm-3 col-xs-12" for="name">Area Group Name:<em>*</em></label>
        <div class="col-md-9 col-sm-9 col-xs-12">
          <input type="text" name="AreaGroupName" required="required" value="<?=$edit['AreaGroupName']?>" class="form-control col-md-7 col-xs-12">
        </div>
        </div>

        <div class="form-group">
        <label class="control-label col-md-2 col-sm-3 col-xs-12" for="name">Area Name:<em>*</em></label>
        <div class="col-md-9 col-sm-9 col-xs-12">
          <input type="text" name="AreaName" required="required" value="<?=$edit['AreaName']?>" class="form-control col-md-7 col-xs-12">
        </div>
        </div>
...
<div class="row" id="add_edit_block_list" <?=($edit)?' style="display:none"':' style="display:block"';?>>
    ...
    <div class="x_panel">
	  <div class="x_title">
		<h2><i class="fa fa-th-list"></i> List of Area</h2>                    
		<div class="clearfix"></div>
	  </div>
	  <div class="x_content">
