          ...
          <div class="col-md-12 col-sm-4 col-xs-12">
          	     <div class="form-group" style="display:none;">
            		...
            		<div class="col-md-9 col-sm-9 col-xs-12">
            		  <input type="hidden" name="news_subheading"  value="<?=$edit['news_subheading']?>" class="form-control col-md-7 col-xs-12">
            		</div>
        		</div>
          ...
          <div class="panel panel-default" style="border: none;">
        	...
        	<div class="panel-body">
        	   ...
        	   <div class="form-group">
                ...
                <div class="form-group">
                    <label class="control-label col-md-2 col-sm-3 col-xs-12" for="name">PDF Book</label>
                   
                    <div class="col-md-4 col-sm-5 col-xs-12">
                       <input type="text" name="big_image_url_caption" value="<?= $edit['big_image_url_caption'] ?>" placeholder="PDF URL" class="form-control">
        	         </div>
                    <div class="col-md-3 col-sm-9 col-xs-12">
...
<?php 
	...
	function __getNewsCatOptions($parentID=false){
		global $db;
		$types=$db->select("SELECT * FROM bn_bas_category WHERE parent=20");
		foreach($types as $type){
