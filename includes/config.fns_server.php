...
define('SCRIPT_URL', "http://localhost/old/FNS/fns24.net/");
define('BASE_DIR' , 'D:/xampp/htdocs/old/FNS/fns24.net/');

#DEFINE DTABASE CONNECTION
define('DB_SERVER', 'localhost');
define('DB_SERVER_USERNAME', 'fns24ban_fouzder');
define('DB_SERVER_PASSWORD', '5HtTz90FL&$y');
define('DB_DATABASE', 'fns24ban_maindb');
...
define('SITE_FROM_EMAIL','info@fns24.net');
