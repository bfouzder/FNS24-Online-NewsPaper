...
if($supplier==0 || $transfer2=="" || $supplier=="" || $transfer2==0 )
{
print"<h1> You Are Not Select Godawn to Godawn </h1>";
exit;
...
<title> Welcome to Transfer  </title>
...
<tr> 
<td width='130' align='center' bgcolor='$set_bg_color'  height='40' id='kh'> <b> Transfer  </b>  </td>
</tr>
<tr> <td align='center' height='10'>  </td></tr>
</table>
...
&nbsp; <font face='arial' size='4'> <b> Transfer  No : </b> $money_id     </font>  </td>
...
<table align='center' width='1000' cellpadding='0' cellspacing='0' bgcolor='black'>
<tr> <td align='left' height='30' bgcolor='white' width='260'> &nbsp;	 <font face='arial' size='4'> <b> Branch / Godawn Name : </b>  $suppliern  
";
...
<table align='center' width='1000' cellpadding='0' cellspacing='0' bgcolor='black'>
<tr> <td align='left' height='30' bgcolor='white'> &nbsp;  <font face='arial' size='4'> <b> Tranfer To : </b>  $transfer2n  &nbsp; $address    </font>  </td></tr>
</table>
...
/*
$sql = "INSERT INTO `saleproduct_transfer` (`user_id`, `money_id`, `supplier_id`, `supplier_name`, `product_id`, `product_name`, `qty`, `price`, `total`, `dat`, `mon`, `yer`, `adat`, `t4`,`buy`, `tax1`, `profit`, `m_type`, `m_id`, `p_type`, `p_id`, `user`, `commission`, `po_no`, `d_no`, `unit`, `project_name`, `u_idd`, `money_id2`, `p_des`, `pe`, `transfer2`, `transfer2n`, `b_code`) VALUES ('','$money_id','$supplier','$suppliern','$product_id','$arrp_new[2]','$quantity','$arrp[21]','$total','$dat','$mon','$yer','$adat','$t4','$arrp_new[4]','$tax1','$profit','$arrpm[1]',' $arrpm[0]','$name[1]','$arrpt[0]','$u_namee','$comm','$po_no','$d_no','$arrp_new[22]','$project_name','$u_idd','$money_id2','$arrp[29]','$f_ppe','$transfer2','$transfer2n','$b_code')";
mysql_query($sql);
*/
...
$sql = "INSERT INTO `buyproduct` (`user_id`, `money_id`, `supplier_id`, `supplier_name`, `product_id`, `product_name`, `qty`, `price`, `total`, `dat`, `mon`, `yer`, `adat`, `t4`, `m_type`, `m_id`, `p_type`, `p_id`, `user`, `commission`, `unit`, `final_price`, `money_id2`, `u_id2`, `model`, `brand`, `capacity`, `origion`, `branch_id`, `branch_using_id`, `tf_id`, `tf`, `name2`) VALUES ('','$money_id','$supplier_111','$transfer2n','$product_id','$arrp_new[2]','$quantity','$arrp[20]','$total','$dat','$mon','$yer','$adat','$t4','$arrpm[1]',' $arrpm[0]','$name[1]','$arrpt[0]','$u_namee','$arrp_new[19]','$arrp_new[22]','$final_price','$money_id2','$u_idd','$arrp_new[3]','$arrp_new[30]','$arrp_new[31]','$arrp_new[32]','$transfer2','$go_id_new','$supplier','1','$suppliern')";
mysql_query($sql);



$sql = "INSERT INTO `saleproduct` (`user_id`, `money_id`, `supplier_id`, `supplier_name`, `product_id`, `product_name`, `qty`, `price`, `total`, `dat`, `mon`, `yer`, `adat`, `t4`,`buy`, `tax1`, `profit`, `m_type`, `m_id`, `p_type`, `p_id`, `user`, `commission`, `po_no`, `d_no`, `unit`, `project_name`, `u_idd`, `money_id2`, `p_des`, `pe`, `wa`, `brand`, `capacity`, `origion`, `model`, `contact_name`, `other`, `branch_id`, `branch_using_id`, `tf_id`, `tf`, `name2`) VALUES ('','$money_id','$supplier_11111','$suppliern','$product_id','$arrp_new[2]','$quantity','$arrp[21]','$total','$dat','$mon','$yer','$adat','$t4','$arrp_new[4]','$tax1','$profit','$arrpm[1]',' $arrpm[0]','$name[1]','$arrpt[0]','$u_namee','$comm','$po_no','$d_no','$arrp_new[22]','$project_name','$u_idd','$money_id2','$arrp[29]','$f_ppe','$local_wa[$w]','$arrp_new[30]','$arrp_new[31]','$arrp_new[32]','$arrp_new[3]','$contact_name','$local_other[$qg]','$supplier','$go_id_new','$transfer2','1','$transfer2n')";
mysql_query($sql);
...
$sql = "INSERT INTO `salememo` (`user_id`, `money_id`, `supplier_id`, `supplier_name`, `product_item`, `total_money`, `less`, `joma`, `due`, `dat`, `mon`, `yer`, `adat`, `t4`, `comments`, `paymenttype`, `tax1`, `subtotal1`, `mobile`, `user`, `commission`, `discount_less`,`pre_bal`, `po_no`, `d_no`, `order_no`, `transport_name`, `contact_name`, `project_name`, `u_idd`, `money_id2`, `vat`, `tax2`, `vat_tk`, `tax2_tk`, `pe`, `address`, `service`, `dcl`, `tin`, `adjust`, `comission_to`, `comission_amount`, `contact_name_new`, `mobile_contact`, `address_contact`, `contact_name_new1`, `mobile_contact1`, `address_contact1`, `branch_id`, `branch_using_id`, `tf_id`, `tf`, `name2`) VALUES ('','$money_id','$supplier_1111','$suppliern','$e','$subtotal','$less','$pa2','$due','$dat','$mon','$yer','$adat','$t4','$comments','$address','$sty','$stotal','$mobile','$u_namee','$lesst','$discount_less','$balance','$po_no','$d_no','$order_no','$transport_name','$contact_name','$project_name','$u_idd','$money_id2','$vat','$tax2','$vat_tk','$tax2_tk','$f_ppe_dis','$address','$service','$dcl','$tin','$adjust','$comission_to','$comission_amount','$contact_namen','$mobile_contact','$address_contact','$contact_namen1','$mobile_contact1','$address_contact1','$supplier','$go_id_new','$transfer2','1','$transfer2n')";
mysql_query($sql);
...
/*
$sql = "INSERT INTO `salememo_transfer` (`user_id`, `money_id`, `supplier_id`, `supplier_name`, `product_item`, `total_money`, `less`, `joma`, `due`, `dat`, `mon`, `yer`, `adat`, `t4`, `comments`, `paymenttype`, `tax1`, `subtotal1`, `mobile`, `user`, `commission`, `discount_less`,`pre_bal`, `po_no`, `d_no`, `order_no`, `transport_name`, `contact_name`, `project_name`, `u_idd`, `money_id2`, `vat`, `tax2`, `vat_tk`, `tax2_tk`, `pe`, `transfer2`, `transfer2n`, `b_code`) VALUES ('','$money_id','$supplier','$suppliern','$e','$subtotal','$less','$payment','$due','$dat','$mon','$yer','$adat','$t4','$comments','$address','$sty','$stotal','$mobile','$u_namee','$lesst','$discount_less','$balance','$po_no','$d_no','$order_no','$transport_name','$contact_name','$project_name','$u_idd','$money_id2','$vat','$tax2','$vat_tk','$tax2_tk','$f_ppe_dis','$transfer2','$transfer2n','$b_code')";
mysql_query($sql);
...
if($payment!=0 && $payment!="")
{
	...
	/*
$commentss="$suppliern  Sales Money Receipt  $payment_moden  $comments $project_name ";
$credit=2;
...
if($payment!=0 && $payment!="")
{
	...
	/*
$commentss="$suppliern  Sales  Money Receipt  $comments $project_name ";
$credit=1;
...
{
	/*
$commentss=" $suppliern  Sales Money Receipt $payment_moden     $comments   ";
$credit=1;
