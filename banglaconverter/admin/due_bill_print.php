...
<tr> <td align='center' height='40'> <font face='arial' size='4'> Due Bill </font> </td> </tr>
...
<form action='due_bill.php' method='POST'>
...
<td align='left' height='' width='180'>  <font face='arial' size='4' color=''> Comments </font> </td> 
...
$result = mysql_query("SELECT * FROM `salememo` where   adat>='$mdate' && adat<='$ndate'  ORDER BY `adat` ASC ");
...
<tr> 
<form action='due_bill_print.php' method='POST' target='_blank'>
<td align='right'>
