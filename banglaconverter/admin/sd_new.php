...
<form action='sd_new.php' method='POST'>
...
$result = mysql_query("SELECT * FROM `create_new2`");
...
$sql = "INSERT INTO `create_new3` (`user_id`, `product_id`, `stock`, `value`, `date`) VALUES ('','$p_id[$i]','$stock_qq','$stock_pp','$mdate')";
mysql_query($sql);
...
<td align='center' height='30' width='180'>  <font face='arial' size='2' color=''>   $prrp_old[$ew]  $pr_new[$ew] </font> </td> 
...
<td align='center' height='30' width='180'>  <font face='arial' size='2' color=''>  $tpyy_old  $profit1  </font> </td> 
...
Total Product's profit : $profit1
...
$result = mysql_query("SELECT * FROM `costing_entry` where expenduter_name='$head_id[$i]' && adat>='$ndate' && adat<='$mdate' && sub_id!='41' && sub_id!='40' && sub_id!='30' && sub_id!='34' && sub_id!='35' && sub_id!='48'   ORDER BY `user_id` ASC  LIMIT 0 , 60000");
