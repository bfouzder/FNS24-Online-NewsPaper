...
$result = mysql_query("SELECT * FROM `salememo_challan_q`  ORDER BY `money_id` DESC  LIMIT 0 , 1 ");
...
<tr> <td height='40' align='center' id='saa'>  <b> Quotation </b> </td> </tr>
</table>
...
<form name='fuu' action='challan_q.php' method='POST'>
...
<font size='2' face='arial' color='black'> <b> Quotation Date </b> </font>
...
: <input type='text' id='txt_c' name='memo_no' value='$me' readonly size='15'> 
...
:  <input type='text' id='text_d' name='new_address' value='$addresss'  size='35'> 
...
: <input type='text' name='contact_name' id='text_d' value='$contact_name' size='15'>  
...
<tr bgcolor='FAFAFA'>
 ...
 <td height='25' bgcolor='' width='150' align='center'> <font face='arial' color='716E6E' size='2'>  <b> Remarks </b> </font> </td>
...
print"
<tr bgcolor='FFFFFF'>
 <td height='30'  width='100' align='center' bgcolor=''> <a href=\"challan_q.php?action=remove&i1d=$arrp_new[0]&sup=$id_supplier&dat=$dat&mon=$mon&yer=$yer&contact_name=$contact_name1&transport_name=$transport_name1&sales_order=$sales_order1&comments=$comments1&new_customer=$new_customer&new_mobile=$new_mobile&new_address=$new_address&ser=$ser\">  <img src='picture/remove.gif'> </a> $sew </td>
 <td height='30' bgcolor='' width='250' align='left'> <font face='arial' color='716E6E' size='2'>  $arrp_new[2]  </font> </td> 
 ...
 <td height='30' bgcolor='' width='50' align='center'> <font face='arial' color='716E6E' size='2'> $arrp[29]  </font> </td>
...
<form action='salememo_challan_q.php' method='POST' target='a_blank'>
...
//{
	print"
<input type='submit' value='Save & Print ' id='enter3'>
";
//}
print"
</td>
