...
$sql= "UPDATE  `expendature_head` SET `category_name`='$category_name' WHERE `user_id`='$s'";
mysql_query($sql);


$sql= "UPDATE  `expendature_head` SET `details`='$details' WHERE `user_id`='$s'";
mysql_query($sql);
...
//$result = mysql_query("DELETE FROM expendature_head WHERE user_id=$d");
...
<head>
<title> Edit expenditure_head </title>
";
...
<table align='center' width='700' cellpadding='0' cellspacing='0'>
<tr> <td align='center' height='28' bgcolor='#7087A3' id='tda'>  <font face='arial' color='white' size='2'> <b> Edit Expenditure Head  </b> </font> </td> </tr>
</table>
...
<form action='eexpendature_head.php' method='POST'>
...
print"	 
	 ...
	 <td align='center' width='70'> <a onClick=\"javascript: return confirm('Are you confirm to delete');\" href=\"eexpendature_head.php?dell=".$a_row[0]."\"> <div id='del'><font face='arial' size='2'> Delete  </font> </div>  </a> </td>
	 ";
