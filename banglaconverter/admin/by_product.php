...
<head>
<title> Single Product Sales View  </title>
";
?>
...
<tr> <td align='center' height='40'> <font face='arial' size='2'> Single Product Sales View  </font> </td> </tr>
...
<form action='by_product.php' method='POST'>
...
";
 ...
 if($g_active==1)
{
print" <font face='arial' size='4'>  Godawn  : </font>
";
...
<td align='left' height='50'>
 ...
 <font face='arial' size='3'> Product Name :  $id  </font> 
";
...
print"
<br>
 <font face='arial' size='3'> Godawn :  $go_gn  </font> 
...
<table align='center' width='900' cellpadding='3' cellspacing='1' bgcolor='black' class='list1'>
...
if($product_id_new=="")
{
$result = mysql_query("SELECT * FROM `saleproduct` where adat>='$mdate' && adat<='$ndate'   && tf!='1' && branch_id='$go_g'  ORDER BY `adat` ASC  LIMIT 0 , 60000 ");
}
else
{
$result = mysql_query("SELECT * FROM `saleproduct` where adat>='$mdate' && adat<='$ndate' && product_id='$product_id_new'   && tf!='1' && branch_id='$go_g' ORDER BY `adat` ASC  LIMIT 0 , 60000 ");
...
if($product_id_new=="")
{
$result = mysql_query("SELECT * FROM `saleproduct_return` where adat>='$mdate' && adat<='$ndate'   && tf!='1' && branch_id='$go_g' ORDER BY `adat` ASC  LIMIT 0 , 60000 ");	
}
else
{
$result = mysql_query("SELECT * FROM `saleproduct_return` where adat>='$mdate' && adat<='$ndate' && product_id='$product_id_new'   && tf!='1'  && branch_id='$go_g' ORDER BY `adat` ASC  LIMIT 0 , 60000 ");
}
}
...
<form action='by_product_print.php' method='POST' target='_blank'>
...
<input type='hidden' name='go_g' value='$go_g'>
