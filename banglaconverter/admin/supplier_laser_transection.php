...
$sql="SELECT * FROM `supplier_laser` WHERE user_id='$d' ";
$result=mysql_query($sql);
...
<head>
<title> Supplier Ledger Transaction </title>
";
?>
...
<tr> <td align='center' height='40'> <font face='arial' size='2'> Supplier Ledger Transaction  </font> </td> </tr>
...
<form name='p' action='supplier_laser_transection.php' method='POST'>

<td align='center' height='40'> 


<font face='arial' size='2'> Select Supplier   </font>
";
...
<table align='center' width='950' cellpadding='5' cellspacing='1' bgcolor='black' class='list1'>
...
if($supplier!="")
{
$result = mysql_query("SELECT * FROM `supplier_laser` where  bank_name='$supplier' && adat>='$mdate' && adat<='$ndate' ORDER BY `user_id` ASC,`adat` ASC ");
}


if($supplier=="")
{
$result = mysql_query("SELECT * FROM `supplier_laser` where   adat>='$mdate' && adat<='$ndate' ORDER BY `user_id` ASC,`adat` ASC ");
}
...
{
print"
<td align='center' width='70'> <a onClick=\"javascript: return confirm('Are you confirm to delete');\" href=\"supplier_laser_transection.php?dell=$a_row[0]&supplier=$id_supplier&dat1=$dat1&mon1=$mon1&yer1=$yer1&dat2=$dat2&mon2=$mon2&yer2=$yer2 \"> <div id='del'><font face='arial' size='2'> Delete  </font> </div>  </a> </td>
";
}
...
<tr> 
<form action='supplier_laser_transection_print.php' method='POST' target='_blank'>
<td align='right'>
