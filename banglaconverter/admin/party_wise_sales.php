...
<form name='p' action='party_wise_sales.php' method='POST'>
...
<input type='text' id='tags2' name='supplier' value='$id_supplier' size='20' onclick='cl()'>
";
...
<td align='left' height='30' width=''>  <font face='arial' size='2' color=''>  $a_row[5]  $a_row[38] $a_row[37] </font> </td> 
...
<table align='center' width='900' cellpadding='3' cellspacing='1' bgcolor='black'>
...
<td align='center' height='30' width='80'>  <font face='arial' size='2' color=''> Commission    </font> </td> 
";
...
{
print"
<td align='center' height='30' width='100'>  <font face='arial' size='2' color=''> Return Profit    </font> </td> 
";
}
...
{
print"
<td align='center' height='30' width=''>  <font face='arial' size='2' color=''> $a_row[26]    </font> </td> 
";
}

$r_total=$r_total+$a_row[26];
...
{
print"
<td align='center' height='30' width=''>  <font face='arial' size='2' color=''> $r_profit   </font> </td> 
";
}
...
<form action='party_wise_sales_print.php' method='POST' target='_blank'>
