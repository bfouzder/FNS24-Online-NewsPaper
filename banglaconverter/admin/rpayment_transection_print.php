...
<head>
<title> Others Receipt Transaction </title>
";
...
<tr> <td align='center' height='40' id='td5'> <font face='arial' size='4'> Receipt Ledger Transaction  </font> </td> </tr>
...
<tr bgcolor=''>
<td align='left' HEIGHT='30'> <font size='4' face='arial'> &nbsp;  Ledger name: $suppliern Address: $address $mobile </font> </td>
</tr>
</table>
...
if($supplier!="")
{
$result = mysql_query("SELECT * FROM `rpayment_transection` where  bank_name='$supplier' && adat<'$mdate' ORDER BY `user_id` ASC ");
}

if($supplier=="")
{
$result = mysql_query("SELECT * FROM `rpayment_transection` where   adat<'$mdate' ORDER BY `user_id` ASC ");
}
...
<td align='center' height='30' width=''>  <font face='arial' size='4' color=''> $a_row[4] </font> </td> 
