...
$result = mysql_query("SELECT * FROM `customer_laser`  where money_id='$bill_no' && money_id!=''  ORDER BY `user_id` ASC  LIMIT 0 , 100000");
...
<head>
<title> Bill To Bill Collection  </title>
";
?>
...
<tr> <td height='30' width='200' bgcolor='green'> &nbsp;&nbsp;&nbsp;  <span id='child'> <b> <font color='white'> Refill </font> </b> </span>  </td></tr>
...
<tr> <td height='50' align='center'> <font size='4' face='arial' color='blue'> Bill to Bill  Collection  </font> </td> </tr>
...
<tr> 
<form action='billtocollection2.php' method='POST'>
...
$result = mysql_query("SELECT * FROM `salememo` where  supplier_id='$supplier'   ORDER BY `adat` ASC ");
...
$result = mysql_query("SELECT * FROM `customer_laser` where  money_id='$bill[$i]'   ORDER BY `adat` ASC ");
...
<tr>
<td width='20'> </td>
<form action='salememo_bill.php' method='POST' target='_blank'>
<td align='center'> 
