...
if($a==0)
{
	...
	/*
$sql = "INSERT INTO `godawn_new` (`user_id`, `category_name`, `details`) VALUES ('','$category_name','$details')";
mysql_query($sql);
*/
...
<head>
<title> Create branch or godawn  </title>
";
...
<form action='create_godawn.php' method='POST'>
...
<tr> 
     <td  bgcolor='' align='right' height='0'> <font face='arial' size='2'> Branch or Godawn Name: </font>   </td>
...
<tr> 
     <td  bgcolor='' align='right' height='0'> <font face='arial' size='2'> Adddress : </font>   </td>
