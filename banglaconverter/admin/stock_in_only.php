...
$result = mysql_query("SELECT * FROM `supplier`  ORDER BY `customer_name` ASC  LIMIT 0 , 100000");
...
<tr> <td align='center' height='40'> <font face='arial' size='4'> Stock In  </font> </td> </tr>
...
<form action='stock_in_only.php' method='POST'>

<td align='center' height='40'> 



<font face='arial' size='2'> Party Name  : 
</font>
...
<table align='center' width='800' cellpadding='0' cellspacing='1' bgcolor='black' class='list1'>
...
{
$result = mysql_query("SELECT * FROM `buyproduct` where adat>='$mdate' && adat<='$ndate' && product_id='$p_id[$i]' && supplier_id='$product_id_new'   && tf!='1' ");
...
<form action='stock_in_print.php' method='POST' target='_blank'>
