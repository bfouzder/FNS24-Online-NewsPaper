...
$sql = "INSERT INTO `cash_book` (`user_id`, `money_id`, `dat`, `mon`, `yer`, `adat`, `time`, `comments`, `debit`, `credit`, `balance`, `user`, `money_id2`, `u_id2`) VALUES ('','$money_id','$dat','$mon','$yer','$adat','$time','$commentss','$debit','$credit','$amount','$u_namee','$money_id2','$u_idd')";
mysql_query($sql);
...
<form action='opening_cash_book.php' method='POST'>
...
<tr> <td align='center' height='40'> <font face='arial' size='2'> Balance Entry Of Cash Book </font> </td> </tr>
