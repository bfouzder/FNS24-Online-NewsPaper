...
$sql="SELECT * FROM `bank_refill` WHERE user_id='$d' ";
...
<tr> <td align='center' height='40'> <font face='arial' size='4'> Bank Ledger  </font> </td> </tr>
...
<form action='bank_transection.php' method='POST'>

<td align='center' height='40'> 


<font face='arial' size='2'> Select Bank Name :   </font>
...
{
print"
<td align='center' width='70'> <a onClick=\"javascript: return confirm('Are you confirm to delete');\" href=\"bank_transection.php?dell=$a_row[0]&supplier=$supplier&dat1=$dat1&mon1=$mon1&yer1=$yer1&dat2=$dat2&mon2=$mon2&yer2=$yer2 \"> <div id='del'><font face='arial' size='2'> Delete  </font> </div>  </a> </td>
";
}
...
<tr> 
<form action='bank_transection_print.php' method='POST' target='_blank'>
<td align='right'>
