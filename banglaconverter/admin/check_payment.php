...
$bank_name="$id_supplier";


$bank_name1="$id_supplier";
$suppliern="$id_supplier";

$bank_namem="$id_supplier";
...
$sql = "INSERT INTO `check_payment` (`user_id`, `customer_name`, `customer_id`, `mobile`, `address`, `bank_name`, `check_no`, `amount`, `dat`, `mon`, `yer`, `adat`, `idat`, `imon`, `iyer`, `iadat`, `active`, `comments`, `bank_id`, `money_id`, `account_no`, `u_name`, `money_id2`, `u_id2`) VALUES ('','$suppliern','$bank_name1','$mobile','$address','$payment_moden','$check_no','$check_amount','$dat','$mon','$yer','$adat','$idat','$imon','$iyer','$iadat','$active','$commentss','$payment_mode','$money_id','$bank_account_no','$u_namee','$money_id2','$u_idd')";
mysql_query($sql);
include_once('s.php');
...
<head>
<title> Payment Cheque Entry  </title>
";
...
<form name='p' action='check_payment.php' method='POST'>
...
<tr> <td align='center' height='40'> <font face='arial' size='3'> Payment Cheque  Entry </font> </td> </tr>
...
<tr> 
<td align='left' height='30' width=''><font color='black' face='arial' size='3'> Name </font> </td> 
<td width='' align='left'>
...
<input type='text' id='tags2' name='supplier' value='$id_supplier' size='27'>
";
...
<td width='' align='left'> <font color='black' face='arial' size='3'> Select Bank Name </font> </td>
