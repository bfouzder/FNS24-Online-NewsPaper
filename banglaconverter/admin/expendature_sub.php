...
$sql="SELECT * FROM `expendature_head` WHERE user_id='$category' ";
...
if($a==0)
{
$sql = "INSERT INTO `expendature_sub` (`user_id`, `category`, `product_name`, `details`) VALUES ('','$category','$product_name','$details')";
mysql_query($sql);
...
<head>
<title> New Expenditure Sub Head </title>
";
...
<form action='expendature_sub.php' method='POST'>
...
<table align='center' width='400' cellpadding='0' cellspacing='0'>
<tr> <td align='center' height='28' bgcolor='#7087A3' id='tda'>  <font face='arial' color='white' size='2'> <b> New Expenditure Sub Head  </b> </font> </td> </tr>
</table>
...
<tr> 
     <td  bgcolor='' align='right' height='0'> <font face='arial' size='2'> Expenditure Head : </font>   </td>
     <td align='left'>&nbsp;
...
<tr> 
     ...
     <td align='left'>&nbsp; <input type='text' id='c9' name='product_name' size='25'> </td> 
</tr>
...
<tr> 
     ...
     <td align='left'>&nbsp; <textarea rows='3' id='c9' cols='20' name='details'> </textarea> </td> 
</tr>
