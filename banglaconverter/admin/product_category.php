...
$sql = "INSERT INTO `product_category` (`user_id`, `category_name`, `details`) VALUES ('','$category_name','$details')";
mysql_query($sql);
}
...
<table align='center' width='400' cellpadding='0' cellspacing='0'>
<tr> <td align='center' height='28' bgcolor='#7087A3' id='tda'>  <font face='arial' color='white' size='2'> <b> New Product Category  </b> </font> </td> </tr>
</table>
...
<tr> 
     <td  bgcolor='' align='right' height='0'> <font face='arial' size='2'> Category Name : </font>   </td>
