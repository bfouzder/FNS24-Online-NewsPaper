...
if($ddddd==100 && $wh>0)
{
$result = mysql_query("DELETE FROM salememo_order WHERE money_id=$memo_no");
$result = mysql_query("DELETE FROM saleproduct_order WHERE money_id=$memo_no");
...
<tr> 
<td width='130' align='center' bgcolor='$set_bg_color'  height='40' id='kh'> <b> Sales Order  </b>  </td>
</tr>
<tr> <td align='center' height='10'>  </td></tr>
</table>
...
<td width='150' align='left'>
<font face='arial' size='4'> <b> : </b> $contact_namen   </font> 
</td>
...
<tr bgcolor='white'>
 ...
 <td width='' align='left'><font face='arial' size='4'>   $arrp_new[2]
";


print"
  $arrp[29]  $nametest[1]  </font> </td>
 ";
...
$sql = "INSERT INTO `saleproduct_order` (`user_id`, `money_id`, `supplier_id`, `supplier_name`, `product_id`, `product_name`, `qty`, `price`, `total`, `dat`, `mon`, `yer`, `adat`, `t4`,`buy`, `tax1`, `profit`, `m_type`, `m_id`, `p_type`, `p_id`, `user`, `commission`, `po_no`, `d_no`, `unit`, `project_name`, `u_idd`, `money_id2`, `p_des`, `pe`, `wa`, `brand`, `capacity`, `origion`, `model`, `contact_name`, `branch_id`, `branch_using_id`) VALUES ('','$money_id','$supplier','$suppliern','$product_id','$arrp_new[2]','$quantity','$arrp[21]','$total','$dat','$mon','$yer','$adat','$t4','$arrp_new[4]','$tax1','$profit','$arrpm[1]',' $arrpm[0]','$name[1]','$arrpt[0]','$u_namee','$comm','$po_no','$d_no','$arrp_new[22]','$project_name','$u_idd','$money_id2','$arrp[29]','$f_ppe','$local_wa[$w]','$arrp_new[30]','$arrp_new[31]','$arrp_new[32]','$arrp_new[3]','$contact_name','$go_other[$qg]','$go_id_new')";
mysql_query($sql);
