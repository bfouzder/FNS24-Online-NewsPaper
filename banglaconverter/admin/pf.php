...
$sql="SELECT * FROM `teacher_profile` WHERE user_id='$bank_name' ";
...
$sql = "INSERT INTO `bank_pf` (`user_id`, `bank_name`,`credit`, `amount`,`comments`,`dat`, `mon`, `yer`, `money_id`, `adat`, `user`, `money_id2`, `u_id2`) VALUES ('','$u','$credit','$amount','$commentss','$dat','$mon','$yer','$money_id','$adat','$u_namee','$money_id2','$u_idd')";
...
<form name='p' action='pf.php' method='POST'>
...
<tr> <td align='center' height='40'> <font face='arial' size='5'> Provident Fund Balance Entry </font> </td> </tr>
...
<tr> 
<td align='right' height='30' width='150'><font face='arial' size='2'> Employee Name: &nbsp;</font> </td> 
<td width='300' align='left'>
";
