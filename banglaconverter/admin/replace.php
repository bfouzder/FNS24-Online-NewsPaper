...
$result = mysql_query("SELECT * FROM `salememo_replace`  ORDER BY `money_id` DESC  LIMIT 0 , 1 ");
...
<form name='fu' action='replace.php' method='POST'> 
...
<a href="#"  onclick="window.open('product_entry.php','name','width=700,height=520,toolbar=no,location=no,directories=no,status=no,menubar=no, scrollbars=no, left=300,top=140,resizable=no, copyhistory=no,titlebar=no')"> <font color='blue'> <b> Create New product </b> </font> </a>
...
<font size='4' face='arial' color='blue'> Product Replacement </font>
<?php
...
<form name='fuu' action='replace.php' method='POST'> 
...
<td width='left'> : <input type='text' name='new_mobile' value='$mobiles' size='15' id='txt'>  &nbsp; 
<font face='arial' size='3' color='716E6E'>   Address:  </font> <input type='text' name='new_address' id='txt' value='$addresss'  size='35'> 
</font>
</td>
</tr>
";
...
<font size='2' face='arial' color='716E6E'> Price: </font> <input type='text' name='price' size='10' id='txx'> 

<font size='2' face='arial' color='716E6E'> Qty: </font> <input type='text' name='qty' size='4' id='txx'> 
";

if($set_wa==1)
{
print"
<font size='2' face='arial' color='716E6E'>  Warranty : </font> <input type='text' name='wa' size='4' id='txx'> 
";
}
...
{
print"
<font size='2' face='arial' color='716E6E'>  Commi : </font> <input type='text' name='less_new' size='4' id='txx'> 
";
}
...
<tr bgcolor='FAFAFA'>
 ...
 <td height='25' bgcolor='' width='30' align='center'> <font face='arial' color='716E6E' size='2'> Unit </font> </td>
";
...
{
print"
 <td height='25' bgcolor='' width='100' align='center'> <font face='arial' color='716E6E' size='2'> Warranty  </font> </td>
";
...
<tr bgcolor='FFFFFF'>
 ...
 print"
 <td height='30' bgcolor='' width='250' align='left'> <font face='arial' color='716E6E' size='2'> &nbsp;
...
{	
print"
 <td height='25' bgcolor='' width='' align='center'> <font face='arial' color='716E6E' size='2'> $local_wa[$sew] </font> </td>
";
}
...
<tr bgcolor='FFFFFF'>
 ...
 <td height='30' bgcolor='' width='100' align='center'> <font face='arial' color='716E6E' size='2'> $qv  </font> </td>
...
<form  name='bv' action='replace.php' method='POST'>
...
print"
<tr> 
<td width='190' align='right'> <font color='black' face='arial' size='2'> Installation Charge  : &nbsp; </font>
</td>
<td width='220' align='left'> 
<input type='text' name='service' value='$service' size='10'> tk
</td>
</tr>
...
<form action='salememo_replace.php' method='POST' target='a_blank'>
<td align='left'> 
...
print"
<tr bgcolor='white'> 
<td bgcolor='' height='30' width='334' align='right'> <font size='2' face='arial' color='716E6E'> Installation Charge : </font> </td> 
<td bgcolor='' height='30' width='146' align='center'><font size='2' face='arial' color='716E6E'>$service tk </font> </td> 
</tr>
";
}
