...
$result = mysql_query("SELECT * FROM `salary_sheet` where adat>='$adat1' && adat<='$adat2'  ORDER BY `user_id` ASC  LIMIT 0 , 60 ");
...
<tr> <td height='28' align='center' id='tda' bgcolor=''> <font size='5' face='arial' color='black'> View Employee Profile   </font> </td> </tr>
</table>
...
<tr bgcolor=''>
<td align='left'> <img src='employee/$picture' width='50' height='50'> </td>
</tr>
...
<form action='profile_print.php' method='POST' target='_blank'>
...
<input type='hidden' name='smon2' value='$smon2'>
<input type='hidden' name='syer2' value='$syer2'>
