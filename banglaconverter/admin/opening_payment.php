...
$sql="SELECT * FROM `payment_laser` WHERE user_id='$bank_name' ";
...
$sql = "INSERT INTO `payment_transection` (`user_id`, `bank_name`,`credit`, `amount`,`comments`,`dat`, `mon`, `yer`, `money_id`, `adat`, `user`, `money_id2`, `u_id2`) VALUES ('','$u','$credit','$amount','$commentss','$dat','$mon','$yer','$money_id','$adat','$u_namee','$money_id2','$u_idd')";
...
<head>
<title> Opening Balance Entry of Payment Laser  </title>
";
...
<form action='opening_payment.php' method='POST'>
...
<tr> <td align='center' height='40'> <font face='arial' size='2'> Opening Balance Entry Of Payment Ledger </font> </td> </tr>
...
<tr> 
<td align='right' height='30' width='150'><font face='arial' size='2'> Payment Ledger Name: &nbsp;</font> </td> 
<td width='300' align='left'>
