...
$result = mysql_query("SELECT * FROM `salememo_order` where user_id='$s45' ORDER BY `user_id` ASC ");	
...
$result = mysql_query("SELECT * FROM `saleproduct_order` where money_id='$invoice_no' ORDER BY `user_id` ASC ");	
...
<tr> <td height='40' align='center' id='saa'>  <b> Sales Order Edit </b> </td> </tr>
</table>
...
<form name='fuu' action='sales_edit_order.php' method='POST'> 
...
print"
<tr bgcolor='FFFFFF'>
 <td height='30'  width='100' align='center' bgcolor=''> <a href=\"sales_edit_order.php?action=remove&i1d=$product_id_unique&s45=$s45&dat=$dat&mon=$mon&yer=$yer&ser=$ser&supplier=$supplier&contact_name=$contact_name&transport_name=$transport_name1&sales_order=$sales_order1&new_customer=$new_customer&new_mobile=$new_mobile&new_address=$new_address&dcl=$dcl&tin=$tin&mobile_contact=$mobile_contact&address_contact=$address_contact&mobile_contact1=$mobile_contact1&address_contact1=$address_contact1&contact_name1=$contact_name1\">  <img src='picture/remove.gif'> </a> $sew </td>
...
<form action='sales_edit_order.php' method='POST'>
...
<form action='salememo_order.php' method='POST' target='a_blank'>
<td align='left'> 
