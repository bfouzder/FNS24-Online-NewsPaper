...
foreach($_SESSION['cart'] as $ptt => $pqq)
{
$pt++;	
}
...
$pt=$money_id;
		                ...
		                $_SESSION['cart'][$pt]=$_SESSION['cart'][$pt]+$qty;
                        $ps=123;
                        $_SESSION['color']="$ps";
						
					    $_SESSION['cart_id'][$pt]=$_SESSION['cart_id'][$pt]+$product_id;
						$_SESSION['cart_price'][$pt]=$_SESSION['cart_price'][$pt]+$price;
						$_SESSION['cart_com'][$pt]=$_SESSION['cart_com'][$pt]+$less_new;
...
/*
foreach($_SESSION['cart_id'] as $pu => $product_id)
{

//$e++;
print" <br> $pu -   $product_id  Test </br> ";
...
$cq='"';	
$cq = mb_ereg_replace("$cq"," Inch", $a_row[2]);
...
<tr> <td height='30' align='center'> <font size='4' face='arial' color='blue'> Product Sales  </font> </td> </tr>
</table>
...
<form name='fu' action='sales_up.php' method='POST'> 
...
print"
<select name='supplier' id='new_sup' onchange='ree()'>
...
<form name='fuu' action='sales_up.php' method='POST'>
";
print"
...
Custom. Mobile: <input type='text' name='sales_ordertt' value='$mobiles' size='15'> 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Address: <input type='text' name='memo_noddd' value='$addresss' readonly size='35'> 
...
<tr> 
<td align='left'> <font face='arial' size='2'> 
Sales Order No: <input type='text' name='sales_order' value='$sales_order' size='15'> 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Invoice No: <input type='text' name='memo_no' value='$me' readonly size='15'> 
&nbsp;
...
$kju++;
print"
<input type='hidden' name='nu$kju' value='$product_id'>
";
...
foreach($_SESSION['cart'] as $pddd => $quantityy)
{
$qc++;
$quantity_n[$qc]=$quantityy;
}


foreach($_SESSION['cart_price'] as $pddd_price => $quantityy_price)
{
$qc_price++;
$quantity_n_price[$qc_price]=$quantityy_price;
}


foreach($_SESSION['cart_com'] as $pddd_com => $quantityy_com)
{
$qc_com++;
$quantity_n_com[$qc_com]=$quantityy_com;
}
...
foreach($_SESSION['cart_id'] as $pdd => $quc)
{

//print"$quc <br>";
 
$sql="SELECT * FROM `product_name` WHERE user_id='$quc' ";
...
$quantity=$quantity_n[$dy];
$arrp[21]=$quantity_n_price[$dy];
$arrp[0]=$pdd;
$arrp[19]=$quantity_n_com[$dy];
...
print"
<tr bgcolor='FFFFFF'>
 <td height='30'  width='100' align='center' bgcolor=''> <a href=\"sales_up.php?action=remove&i1d=$arrp[0]&sup=$supplier&dat=$dat&mon=$mon&yer=$yer\">  <img src='picture/remove.gif'> </a> $sew </td>
...
<form action='sales_up.php' method='POST'>
...
<td width='190' align='right'> <font color='blue' face='arial' size='2'> Carring Cost : &nbsp; </font>
</td>
