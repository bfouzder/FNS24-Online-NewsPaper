...
<head>
<title> Daily product store </title>
";
?>
...
<tr> <td align='center' height='40'> <font face='arial' size='5'> Product Store View  </font> </td> </tr>
...
<td align='left' height='30' width='180'>  <font face='arial' size='4' color=''> &nbsp; Quantity    </font> </td> 
</tr>
";
...
$result = mysql_query("SELECT * FROM `buyproduct` where adat>='$mdate' && adat<='$ndate' && product_id='$p_id[$i]' && tf!='1' ");
...
print"
<tr bgcolor='white'> 
<td align='left' height='30' width='200'>  <font face='arial' size='4' color=''> &nbsp; $p_n[$i]  $capacity[$i] $brand[$i]  </font> </td> 


<td align='left' height='30' width='180'>  <font face='arial' size='4' color=''> &nbsp; $q  </font> </td> 
...
print"
<tr bgcolor='white'> 
<td align='left' height='30' width='200'>  <font face='arial' size='4' color=''>  &nbsp; Total  </font> </td> 

<td align='left' height='30' width='180'>  <font face='arial' size='4' color=''> &nbsp; $total_q  </font> </td> 
</tr>
";
...
<tr bgcolor='white'> <td align='center' height='40'> <font face='arial' size='5'> Product Return </font> </td> </tr>
</table>
...
$result = mysql_query("SELECT * FROM `saleproduct_return` where adat>='$mdate' && adat<='$ndate' && product_id='$p_id[$i]' && tf!='1' ");
...
<td align='left' height='30' width='180'>  <font face='arial' size='4' color=''> &nbsp; $total_q1 </font> </td> 
</tr>
";
...
<br>
<table align='center' width='400' cellpadding='0' cellspacing='1' bgcolor='black'>
<tr bgcolor='white'> <td align='center' height='40'> <font face='arial' size='4'> Transfer From $godawn_name[$mf] </font> </td> </tr>
</table>
<br>
";
...
$result = mysql_query("SELECT * FROM `saleproduct_transfer` where adat>='$mdate' && adat<='$ndate' && transfer2='$tf2' && supplier_id='$mf' && product_id='$p_id[$i]' ");
...
print"
<tr bgcolor='white'> 
<td align='left' height='30' width='200'>  <font face='arial' size='4' color=''> &nbsp; $p_n[$i]  - Code $product_code[$i]  </font> </td> 
...
<td align='left' height='30' width='180'>  <font face='arial' size='4' color=''> &nbsp; $total_q2 </font> </td> 
</tr>
";
...
$total_final=$tm+$total_q1+$total_q;
...
print"
<tr bgcolor='white'> 
<td align='left' height='30' width='200'>  <font face='arial' size='4' color=''>  &nbsp; All Total  </font> </td> 

<td align='left' height='30' width='180'>  <font face='arial' size='4' color=''> &nbsp; $total_final </font> </td> 
</tr>
";
...
<form action='product_store_print.php' method='POST' target='a_blank'>
