...
/*
$sql="SELECT * FROM `payment_laser` WHERE customer_id='$customer_id' ";
...
if($a==0)
{
$sql = "INSERT INTO `payment_laser` (`user_id`, `customer_name`, `customer_id`, `mobile`, `email`, `address`) VALUES ('','$customer_name','$customer_id','$mobile','$email','$address')";
mysql_query($sql);
...
<head>
<title> New Payment Ledger Name </title>
";
...
<form action='payment_laser.php' method='POST'>
...
<table align='center' width='400' cellpadding='0' cellspacing='0'>
<tr> <td align='center' height='28' bgcolor='#7087A3' id='tda'>  <font face='arial' color='white' size='2'> <b> New Payment Ledger   </b> </font> </td> </tr>
</table>
...
<tr> 
     <td  bgcolor='' align='right' height='0'> <font face='arial' size='2'> Ledger ID : </font>   </td>
     <td align='left'>&nbsp; <input type='text' id='c9'  name='customer_id' size='26'> </td> 
</tr>
