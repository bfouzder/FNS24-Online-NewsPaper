...
if($a==0)
{
$sql = "INSERT INTO `contact` (`user_id`, `customer_name`, `customer_id`, `mobile`, `email`, `address`, `area`, `company_name`) VALUES ('','$customer_name','$customer_id','$mobile','$email','$address','$category','$company_name')";
mysql_query($sql);
...
print"
<table align='center' width='600' cellpadding='0' cellspacing='0'>
<tr> <td align='center' height='28' bgcolor='#7087A3' id='tda'>  <font face='arial' color='white' size='2'> <b> Sales Person  </b> </font> </td> </tr>
</table>
...
<table align='center' width='600' cellpadding='0' cellspacing='0' bgcolor='EFEBEB'>
...
/*
<tr> 
     <td  bgcolor='' align='right' height='0'> <font face='arial' size='2'> Contact Name : </font>   </td>
     <td align='left'>&nbsp;
...
$result = mysql_query("SELECT * FROM `contact`  ORDER BY `company_name` ASC  LIMIT 0 , 60000 ");
