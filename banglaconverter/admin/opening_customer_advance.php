...
$sql = "INSERT INTO `customer_advance` (`user_id`, `bank_name`,`credit`, `amount`,`comments`,`dat`, `mon`, `yer`, `money_id`, `adat`, `user`, `money_id2`, `u_id2`) VALUES ('','$u','$credit','$amount','$commentss','$dat','$mon','$yer','$money_id','$adat','$u_namee','$money_id2','$u_idd')";
...
<head>
<title> Opening Balance Entry of Customer Advance  </title>
";
?>
...
<form name='p' action='opening_customer_advance.php' method='POST'>
...
<tr> <td align='center' height='40'> <font face='arial' size='4'> Opening Balance Entry Of Customer Advance  </font> </td> </tr>
