...
$sql="SELECT * FROM `salememo_challan_q` WHERE user_id='$d' ";
...
$result = mysql_query("DELETE FROM salememo_challan_q WHERE user_id=$du");
$result = mysql_query("DELETE FROM saleproduct_challan_q WHERE money_id=$m_id");
...
<tr> <td align='center' height='40'> <font face='arial' size='4'> Quotation View  </font> </td> </tr>
...
<form action='challan_view_q.php' method='POST'>

<td align='center' height='40'> 

<font face='arial' size='2'> Quotation  No : <input type='text' name='memo_no' size='15'> &nbsp;&nbsp; </font>
...
<td align='center' height='30' width='100'>  <font face='arial' size='2' color=''> Qut. No </font> </td> 
...
if($memo_no=="")
{
$result = mysql_query("SELECT * FROM `salememo_challan_q` where adat>='$mdate' && adat<='$ndate' && total_money!='' && pas_type='$pas_type' ORDER BY `adat` ASC ");
}
else
{
$result = mysql_query("SELECT * FROM `salememo_challan_q` where money_id='$memo_no' && pas_type='$pas_type' || po_no='$memo_no' || d_no='$memo_no' ORDER BY `adat` ASC ");	
}
...
if($memo_no=="")
{
$result = mysql_query("SELECT * FROM `salememo_challan_q` where adat>='$mdate' && adat<='$ndate' && total_money!='' ORDER BY `adat` ASC ");
}
else
{
$result = mysql_query("SELECT * FROM `salememo_challan_q` where money_id='$memo_no' || po_no='$memo_no' || d_no='$memo_no' ORDER BY `adat` ASC ");	
}	
...
if($supplier!="")
{
$result = mysql_query("SELECT * FROM `salememo_challan_q` where adat>='$mdate' && adat<='$ndate' && total_money!='' && supplier_id='$supplier'  ORDER BY `adat` ASC ");
$ckk=1;
}
...
<td width='100' align='center'>              <font face='arial' size='2'>  $a_row_old[14]  </font> </td>


<form action='salereceitview1_challan_q.php' method='POST' target='_blank'>
...
<form action='challan_edit_q.php' method='POST' target='_blank'>
<td width='100' align='center'>  
...
{
print"
<td align='center' width='70'> <a onClick=\"javascript: return confirm('Are you confirm to delete');\" href=\"challan_view_q.php?dell=$a_row[0]&supplier=$id_supplier&dat1=$dat1&mon1=$mon1&yer1=$yer1&dat2=$dat2&mon2=$mon2&yer2=$yer2 \"> <div id='del'><font face='arial' size='2'> Delete  </font> </div>  </a> </td>
";
}
