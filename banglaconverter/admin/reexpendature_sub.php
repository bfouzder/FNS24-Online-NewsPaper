...
$sql= "UPDATE  `rexpendature_sub` SET `product_name`='$product_name' WHERE `user_id`='$s'";
mysql_query($sql);

$sql= "UPDATE  `rexpendature_sub` SET `details`='$details' WHERE `user_id`='$s'";
mysql_query($sql);
...
$result = mysql_query("DELETE FROM rexpendature_sub WHERE user_id=$d");
...
<tr> <td height='30' width='200' bgcolor='green'> &nbsp;&nbsp;&nbsp;  <span id='child'> <b> <font color='white'> Edit Receipt sub </font> </b> </span>  </td></tr>
...
<tr> <td align='center' height='28' bgcolor='#7087A3' id='tda'>  <font face='arial' color='white' size='2'> <b> Edit Receipt sub  </b> </font> </td> </tr>
</table>
...
$result = mysql_query("SELECT * FROM `rexpendature_head`  ORDER BY `user_id` ASC  LIMIT 0 , 60000 ");
...
$result = mysql_query("SELECT * FROM `rexpendature_sub` where category='$c_id[$i]' ORDER BY `user_id` ASC  LIMIT 0 , 60000 ");
...
<form action='reexpendature_sub.php' method='POST'>
...
{
print"	 
	 <td align='center' width='70'> <a onClick=\"javascript: return confirm('Are you confirm to delete');\" href=\"reexpendature_sub.php?dell=".$a_row[0]."\"> <div id='del'><font face='arial' size='2'> Delete  </font> </div>  </a> </td>
	 ";
