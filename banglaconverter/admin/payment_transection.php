...
$sql="SELECT * FROM `payment_transection` WHERE user_id='$d' ";
...
$result = mysql_query("DELETE FROM payment_transection WHERE money_id2=$m_id2");
$result = mysql_query("DELETE FROM tcosting_entry WHERE money_id2=$m_id2");
$result = mysql_query("DELETE FROM costing_entry WHERE money_id2=$m_id2");
...
<head>
<title> Payment Ledger Transection </title>
";
...
<tr> <td align='center' height='40'> <font face='arial' size='2'> Payment Ledger Transaction  </font> </td> </tr>
...
<form action='payment_transection.php' method='POST'>
...
$result = mysql_query("SELECT * FROM `payment_laser` where user_id='$sup_office'  ORDER BY `customer_name` ASC ");
...
<tr bgcolor='F2F2F2'>
<td align='left' HEIGHT='30'> <font size='2' face='arial'> &nbsp; Payment Ledger name: $suppliern Address: $address $mobile </font> </td>
</tr>
</table>
...
<td align='center' height='' width='220'>  <font face='arial' size='2' color=''> Comments </font> </td> 
...
{
print"
<td align='center' width='70'> <a onClick=\"javascript: return confirm('Are you confirm to delete');\" href=\"payment_transection.php?dell=$a_row[0]&supplier=$supplier&dat1=$dat1&mon1=$mon1&yer1=$yer1&dat2=$dat2&mon2=$mon2&yer2=$yer2 \"> <div id='del'><font face='arial' size='2'> Delete  </font> </div>  </a> </td>
";
}
...
<td width='100' align='center'>              <font face='arial' size='2'> $balance_mis   </font> </td>
...
<tr> 
<form action='payment_transection_print.php' method='POST' target='_blank'>
<td align='right'>
