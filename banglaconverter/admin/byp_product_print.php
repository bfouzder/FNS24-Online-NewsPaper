...
<tr> <td align='center' height='40'> <font face='arial' size='4'> Product Store View  </font> </td> </tr>
...
<form action='byp_product.php' method='POST'>
...
<td align='center' height='30' width='180'>  <font face='arial' size='4' color=''> Supplier Name </font> </td> 
...
{
$q=0;
$result = mysql_query("SELECT * FROM `buyproduct` where adat>='$mdate' && adat<='$ndate'   && tf!='1' ORDER BY `adat` ASC  LIMIT 0 , 60000 ");
}
else
{
$q=0;
$result = mysql_query("SELECT * FROM `buyproduct` where adat>='$mdate' && adat<='$ndate' && product_id='$product_id_new'  && tf!='1' ORDER BY `adat` ASC  LIMIT 0 , 60000 ");
}
...
<form action='byp_product_print.php' method='POST' target='a_blank'>
