...
$sql="SELECT * FROM `buymemo_return` WHERE user_id='$d' ";
...
$result = mysql_query("SELECT * FROM `buyproduct_return` where money_id='$m_id' ");
...
mysql_query($sql);
$result = mysql_query("DELETE FROM buyproduct_return WHERE user_id=$uid[$i]");
}
*/
...
$result = mysql_query("DELETE FROM buymemo_return WHERE money_id2=$m_id2");
$result = mysql_query("DELETE FROM cash_book WHERE money_id2=$m_id2");
$result = mysql_query("DELETE FROM buyproduct_return WHERE money_id2=$m_id2");
...
<head>
<title> Daily Purchase Return </title>
";
?>
...
<tr> <td align='center' height='40'> <font face='arial' size='2'> Daily Purchase Return  </font> </td> </tr>
...
<form action='daily_purchase_return.php' method='POST'>
...
if($memo_no=="")
{
$result = mysql_query("SELECT * FROM `buymemo_return` where adat>='$mdate' && adat<='$ndate' && total_money!='' ");
}
else
{
$result = mysql_query("SELECT * FROM `buymemo_return` where money_id='$memo_no' ");	
}
...
{
$result = mysql_query("SELECT * FROM `buymemo_return` where adat>='$mdate' && adat<='$ndate' && total_money!=''   && tf!='1' ");
$ckk=1;
}

if($supplier!="")
{
$result = mysql_query("SELECT * FROM `buymemo_return` where adat>='$mdate' && adat<='$ndate' &&  supplier_id='$supplier'   && tf!='1' ");
$ckk=1;
}
...
<form action='buyreceitview2_return.php' method='POST' target='_blank'>
...
print"
<td align='center' width='70'> <a onClick=\"javascript: return confirm('Are you confirm to delete');\" href=\"daily_purchase_return.php?dell=$a_row[0]&supplier=$supplier&dat1=$dat1&mon1=$mon1&yer1=$yer1&dat2=$dat2&mon2=$mon2&yer2=$yer2 \"> <div id='del'><font face='arial' size='2'> Delete  </font> </div>  </a> </td>
";
...
<br>
<br>
 <font face='arial' size='4'> &nbsp;&nbsp;&nbsp; Total Purchase Return: $tyuu </font>
