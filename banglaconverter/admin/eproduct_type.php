...
$sql= "UPDATE  `product_type` SET `category_name`='$category_name' WHERE `user_id`='$s'";
mysql_query($sql);

$sql= "UPDATE  `product_type` SET `details`='$details' WHERE `user_id`='$s'";
mysql_query($sql);
}
...
{
include_once('connection1.php');
// $result = mysql_query("DELETE FROM product_type WHERE user_id=$d");
}
...
<table align='center' width='700' cellpadding='0' cellspacing='0'>
<tr> <td align='center' height='28' bgcolor='#7087A3' id='tda'>  <font face='arial' color='white' size='2'> <b> Edit Product Unit Name  </b> </font> </td> </tr>
</table>
...
<tr bgcolor='gray' height='40'> 
     <td  bgcolor='' align='center' height='0' width=''> <font face='arial' size='2'> Type Name </font> </td>
...
<form action='eproduct_type.php' method='POST'>
...
{
print"
	 <td align='center' width='70'> <a onClick=\"javascript: return confirm('Are you confirm to delete');\" href=\"eproduct_type.php?dell=".$a_row[0]."\"> <div id='del'><font face='arial' size='2'> Delete  </font> </div>  </a> </td>
	 ";
