...
<tr> <td align='center' height='40'> <font face='arial' size='2'> Due Payment </font> </td> </tr>
...
$result = mysql_query("SELECT * FROM `buymemo` where   adat>='$mdate' && adat<='$ndate'  ORDER BY `adat` ASC ");
