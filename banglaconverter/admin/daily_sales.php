...
<table align='center' width='1500' cellpadding='0' cellspacing='1' bgcolor=''>
...
<tr> <td align='center' height='40'> <font face='arial' size='4'> Daily Sales  </font> </td> </tr>
...
<input type='text' id='supplier' name='supplier' value='$id_supplier' size='30'>
";
...
<table align='center' width='1900' cellpadding='5' bgcolor='black' cellspacing='1' class='list1'>
...
<td align='center' height='30' width='380'>  <font face='arial' size='2' color=''> Customer Name - Id</font> </td> 


<td align='center' height='30' width='10'>  <font face='arial' size='2' color=''> Comi. To </font> </td> 
...
<td width='140' align='center'>             <font face='arial' size='2'> Date</font> </td>
...
<td width='100' align='center'>              <font face='arial' size='2'>  Challan Name  </font> </td>
<td width='100' align='center'>              <font face='arial' size='2'>  Challan Mobile </font> </td>
...
if($memo_no!="")
{
$result = mysql_query("SELECT * FROM `salememo` where money_id='$memo_no'  || po_no='$memo_no' || d_no='$memo_no' || order_no='$memo_no' ORDER BY `adat` ASC,`user_id` ASC ");		
$ckk=1;
}
...
{
$result = mysql_query("SELECT * FROM `salememo` where adat>='$mdate' && adat<='$ndate' && total_money!=''   && tf!='1'  ORDER BY `adat` ASC,`user_id` ASC ");
$ckk=1;
}

if($supplier!="")
{
$result = mysql_query("SELECT * FROM `salememo` where adat>='$mdate' && adat<='$ndate' && total_money!='' && supplier_id='$supplier'   && tf!='1'  ORDER BY `adat` ASC,`user_id` ASC ");
$ckk=1;
}
...
<td align='left' height='30' width=''>  <font face='arial' size='2' color=''> $a_row[1] / $a_row[33]   </font> </td> 

<td align='left' height='30' width=''>  <font face='arial' size='2' color=''> $a_row[3]  - $a_row[2] By $a_row[50] </font> </td> 
...
<td> <input type='text' name='new_challan_name' size='10' value='$a_row[61]'>
 </td>

<td> <input type='text' name='new_challan_mobile' size='10' value='$a_row[62]'>
 </td>

<td> <input type='text' name='new_challan_address' size='10' value='$a_row[63]'>
 </td>
