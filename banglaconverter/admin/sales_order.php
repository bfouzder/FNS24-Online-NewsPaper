...
$result = mysql_query("SELECT * FROM `salememo_order`  ORDER BY `money_id` DESC  LIMIT 0 , 1 ");
...
<tr> <td height='30' width='200' bgcolor='green'>   <span id='child'> <b> <font color='white'> Sales Order </font> </b> </span>  </td></tr>
...
<tr> <td height='40' align='center' id='saa'>  <b> Sales Order </b> </td> </tr>
</table>
...
<form name='fuu' action='sales_order.php' method='POST'> 
...
<font size='2' face='arial' color='black'> <b>&nbsp; Order Date   </b> </font>
...
<tr>
<td width='0' align='left'> <font size='2' face='arial' color='black'> <b> &nbsp; Order No  </b> </font> </td>
<td align='left'> 
";
...
print"
<tr bgcolor='FFFFFF'>
 <td height='30'  width='100' align='center' bgcolor=''> <a href=\"sales_order.php?action=remove&i1d=$product_id_unique&sup=$id_supplier&dat=$dat&mon=$mon&yer=$yer&contact_name=$contact_name11&contact_name1=$contact_name111&transport_name=$transport_name1&sales_order=$sales_order1&project_name=$project_name&new_customer=$new_customer&new_mobile=$new_mobile&new_address=$new_address&ser=$ser&dcl=$dcl&tin=$tin\">  <img src='picture/remove.gif'> </a> $sew </td>
 ";
...
<form  name='bv' action='sales_order.php' method='POST'>
...
<form  name='nf' action='salememo_order.php' method='POST' target='a_blank'>
