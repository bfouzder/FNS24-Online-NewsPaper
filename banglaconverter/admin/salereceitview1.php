...
if($sa!="")
{
$sql="SELECT * FROM `salememo` WHERE money_id2='$sa' ";
$result=mysql_query($sql);
$arrasa=mysql_fetch_array($result);
$s=$arrasa[0];
}
...
<tr bgcolor='white'>
 ...
 <td width='' align='left'><font face='arial' size='4'>   $a_row[5] $a_row[42] $a_row[34]  $a_row_test[19]    </font> </td>
";
