...
if($product_group=="" || $product_group=="all" )
{
$pron="All";
$product_group="all";
}
...
<tr> <td align='center' height='40'> <font face='arial' size='5'> <b> Product Stock View </b>  </font> </td> </tr>
...
<table align='center' width='1380' cellpadding='0' cellspacing='0' bgcolor=''>



<tr> 

<form action='only.php' method='POST'>
...
";
 ...
 if($g_active==1)
{
print" <font face='arial' size='5'>  Branch / Godawn  : </font>
";

print"
<select name='go_g' id='group_new'>

<option value='$go_g'>$go_gn</option>
...
print"
<font face='arial' size='5'>  Product Group :
</font>
<select name='product_group' id='group_new'>
...
<font face='arial' size='5'> Product: 
</font>
...
<table align='center' width='1080' cellpadding='5' cellspacing='1' bgcolor='black' class='list1'>

<tr bgcolor='F2F2F2'>

<td align='center' height='30' width='30'>  <font face='arial' size='5' color=''> <b> SL. </font> </td> 
 
<td align='center' height='30' width='600'>  <font face='arial' size='5' color=''> <b> Product Name </font> </td> 
<td align='center' height='30' width='400'>  <font face='arial' size='5' color=''> <b> Stock   </font> </td> 
...
{
$result = mysql_query("SELECT * FROM `saleproduct_return` where  adat<='$mdate' && product_id='$p_id[$i]' && branch_id='$go_g' ORDER BY `adat` ");
...
{
$result = mysql_query("SELECT * FROM `saleproduct_return` where adat>='$ndate' && adat<='$mdate' && product_id='$p_id[$i]' && branch_id='$go_g'ORDER BY `adat` ");
...
{
$result = mysql_query("SELECT * FROM `buyproduct_return` where  adat<='$mdate' && product_id='$p_id[$i]' && branch_id='$go_g' ORDER BY `adat` ");
...
{
$result = mysql_query("SELECT * FROM `saleproduct` where adat<'$ndate'   && product_id='$p_id[$i]' && branch_id='$go_g' ORDER BY `adat` ");
}
...
{
$result = mysql_query("SELECT * FROM `saleproduct` where adat>='$ndate' && adat<='$mdate'  && product_id='$p_id[$i]' && branch_id='$go_g' ORDER BY `adat` ");
}
...
{
$result = mysql_query("SELECT * FROM `buyproduct` where  adat<='$mdate'  && product_id='$p_id[$i]' && branch_id='$go_g' ");
}
while ($a_row = mysql_fetch_row($result)) {
...
<td> <font face='arial' size='5' color=''> $p_id_old[$i] $mn </font> </td>
<td align='left' height='30' width=''>  <font face='arial' size='5' color=''>   $p_n[$i]  $code[$i]  $size[$i]  $brand[$i]   $origion[$i] $bbb_old   </font> </td> 

<td align='right' height='30' width=''>  <font face='arial' size='5' color=''>  $stock_q  </font> </td> 
...
<td>  </td>
<td align='center' height='30' width=''>  <font face='arial' size='5' color=''> Total   </font> </td> 
";
...
print"
<td align='right' height='30' width=''>  <font face='arial' size='5' color=''>   $stock_qq  </font> </td> 
