...
$sql="SELECT * FROM `supplier` WHERE user_id='$bank_name' ";
...
$sql = "INSERT INTO `supplier_advance` (`user_id`, `bank_name`,`credit`, `amount`,`comments`,`dat`, `mon`, `yer`, `money_id`, `adat`, `user`, `money_id2`, `u_id2`) VALUES ('','$u','$credit','$amount','$commentss','$dat','$mon','$yer','$money_id','$adat','$u_namee','$money_id2','$u_idd')";
...
<head>
<title> Opening Balance Entry of Supplier Advance  </title>
";
?>
...
<form name='p' action='opening_supplier_advance.php' method='POST'>
...
<tr> <td align='center' height='40'> <font face='arial' size='2'> Opening Balance Entry Of Supplier Advance </font> </td> </tr>
...
<tr> 
<td align='right' height='30' width='150'><font face='arial' size='2'> Select Supplier Name: &nbsp;</font> </td> 
<td width='300' align='left'>
...
<td width='300' align='left'> <input type='text' name='amount'  size='30' id='txt'> </td>
</tr>
