...
print"
<table align='center' width='1200' cellpadding='0' cellspacing='0' height='800'>
<tr bgcolor='white'> 
";
...
<tr> <td align='center' height='40'> <font face='arial' size='4'> Party Product Sales Quantity   </font> </td> </tr>
...
<form action='party_sale.php' method='POST'>
...
print"
<font face='arial' size='3'> Customer: 
</font>
...
$result = mysql_query("SELECT * FROM `saleproduct` where adat>='$mdate' && adat<='$ndate' && product_id='$p_id[$i]' && supplier_id='$supplier' ");
...
print"
<tr bgcolor='white'> 
<td align='left' height='30' width='100'>  <font face='arial' size='3' color=''> &nbsp;  $p_n[$i] $capacity[$i] $brand[$i]  $ptt_old </font> </td> 
...
<form action='party_sale_print.php' method='POST' target='a_blank'>
