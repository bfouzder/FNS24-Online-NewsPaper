...
$new_challan_name=trim($_POST['new_challan_name']);
$new_challan_mobile=trim($_POST['new_challan_mobile']);
$new_challan_address=trim($_POST['new_challan_address']);


$new_challan_name=str_replace("'","`","$new_challan_name");
$new_challan_mobile=str_replace("'","`","$new_challan_mobile");
$new_challan_address=str_replace("'","`","$new_challan_address");




$sql= "UPDATE  `salememo` SET `challan_name`='$new_challan_name' WHERE `user_id`='$s'";
mysql_query($sql);

$sql= "UPDATE  `salememo` SET `challan_mobile`='$new_challan_mobile' WHERE `user_id`='$s'";
mysql_query($sql);

$sql= "UPDATE  `salememo` SET `challan_address`='$new_challan_address' WHERE `user_id`='$s'";
mysql_query($sql);
...
$contact_name=$arra[53];
$mobile_contact=$arra[54];
...
if($new_challan_name!="")
{
$suppliern="$new_challan_name";
}


if($new_challan_mobile!="")
{
$mobile="$new_challan_mobile";
}



if($new_challan_address!="")
{
$address="$new_challan_address";
}
...
<td align='left' height='30' bgcolor='white' width='830'> 
...
<td align='left' height='30' bgcolor='white' width='160'> 
&nbsp; <font face='arial' size='4'>  <b>  Name  </b>   </font>  </td>
...
<td width='150' align='left'>
<font face='arial' size='4'> <b>  </b> $order_no_old  </font> 
</td>
";
...
<tr> <td align='center' height='10'>  </td></tr>
<tr> 
<td width='300' align='left'><a href=\"sales.php?action=removee&i5d=$arrp[0]\"> <font face='arial' size='4' color='black'> &nbsp;&nbsp;  <b>  </b> </font> </a> </td>
<td width='130' align='center' bgcolor='cccccc'><font face='arial' size='4'> <b> Challan  </b> </font> </td>
<td width='270' align='right'><font face='arial' size='4'>  </font> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
</tr>
<tr> <td align='center' height='10'>  </td></tr>
</table>
...
$result = mysql_query("SELECT * FROM `saleproduct` where money_id='$memo_id' ORDER BY `user_id` ASC ");
...
<tr bgcolor='white'>
 ...
 <td width='300' align='left'><font face='arial' size='4'>   $a_row[5]  $a_row[42]   $a_row[34]    </font> </td>
 ";
...
print"
 ...
 print"
 <td width='' align='center'><font face='arial' size='4'>   $tq  </font> </td> 
 <td width='' align='center'><font face='arial' size='4'>     </font> </td> 
 ";
