...
$sql= "UPDATE  `rexpendature_head` SET `category_name`='$category_name' WHERE `user_id`='$s'";
mysql_query($sql);


$sql= "UPDATE  `rexpendature_head` SET `details`='$details' WHERE `user_id`='$s'";
mysql_query($sql);
...
$result = mysql_query("DELETE FROM rexpendature_head WHERE user_id=$d");
...
<tr> <td height='30' width='200' bgcolor='green'> &nbsp;&nbsp;&nbsp;  <span id='child'> <b> <font color='white'> Receipt Head </font> </b> </span>  </td></tr>
...
<table align='center' width='700' cellpadding='0' cellspacing='0'>
<tr> <td align='center' height='28' bgcolor='#7087A3' id='tda'>  <font face='arial' color='white' size='2'> <b> Edit Receipt head  </b> </font> </td> </tr>
</table>
...
<tr bgcolor='gray' height='40'> 
     <td  bgcolor='' align='center' height='0' width=''> <font face='arial' size='2'>  Name </font> </td>
...
<form action='reexpendature_head.php' method='POST'>
...
print"	 
	 ...
	 <td align='center' width='70'> <a onClick=\"javascript: return confirm('Are you confirm to delete');\" href=\"reexpendature_head.php?dell=".$a_row[0]."\"> <div id='del'><font face='arial' size='2'> Delete  </font> </div>  </a> </td>
	 ";
}
