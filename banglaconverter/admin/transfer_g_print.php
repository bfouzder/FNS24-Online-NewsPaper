...
print"
<table align='center' width='1000' cellpadding='0' cellspacing='0' height='' bgcolor=''>
<tr bgcolor='white'> 
";
...
<tr> <td align='center' height='40'> <font face='arial' size='4'>  Transfer Product   </font> </td> </tr>
...
<form action='transfer_g.php' method='POST'>
...
<font face='arial' size='4'> Branch / Godawn : 
</font>
...
<td align='center' height='30' width='100'>  <font face='arial' size='4' color=''> Date </font> </td> 
 <td align='center' height='30' width='180'>  <font face='arial' size='4' color=''> Transfer To Transfer  </font> </td> 
...
if($transfer2=="")
{
$result = mysql_query("SELECT * FROM `saleproduct` where adat>='$mdate' && adat<='$ndate' && branch_id='$supplier'  && tf='1'  ORDER BY `adat` ASC  LIMIT 0 , 60000 ");
}
else
{
$result = mysql_query("SELECT * FROM `saleproduct` where adat>='$mdate' && adat<='$ndate' && branch_id='$supplier' && tf_id='$transfer2' && tf='1'  ORDER BY `adat` ASC  LIMIT 0 , 60000 ");
...
<td align='center' height='30' width=''>  <font face='arial' size='4' color=''> $a_row[9]-$a_row[10]-$a_row[11] <br> $a_row[1] </font> </td> 
 <td align='left' height='30' width=''>  <font face='arial' size='4' color=''>  $a_row[3] To $a_row[47] </font> </td> 
...
<form action='transfer_g_print.php' method='POST' target='_blank'>
