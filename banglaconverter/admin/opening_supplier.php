...
$sql = "INSERT INTO `supplier_laser` (`user_id`, `bank_name`,`credit`, `amount`,`comments`,`dat`, `mon`, `yer`, `money_id`, `adat`, `user`, `money_id2`, `u_id2`) VALUES ('','$u','$credit','$amount','$commentss','$dat','$mon','$yer','$money_id','$adat','$u_namee','$money_id2','$u_idd')";
...
<head>
<title> Opening Balance Entry of Supplier  </title>
";
?>
...
<form name='p' action='opening_supplier.php' method='POST'>
...
<tr> <td align='center' height='40'> <font face='arial' size='2'> Opening Balance Entry Of Supplier </font> </td> </tr>
